...
<body>
    ...
    <div class="actions">
        <a href="{{ route('pdf.download5', $student->id) }}" class="btn btn-download">💾 تحميل PDF</a>
        <a href="javascript:history.back()" class="btn btn-back">↩ رجوع</a>
         <form action="{{ route('certificates.sendEmail', [$student->id, 5]) }}" method="POST" style="display: inline;">
        @csrf
