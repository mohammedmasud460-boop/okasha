...
<body>
    ...
    <div class="actions">
        <a href="{{ route('pdf.download7', $student->id) }}" class="btn btn-download">💾 تحميل PDF</a>
        <a href="javascript:history.back()" class="btn btn-back">↩ رجوع</a>
         <form action="{{ route('certificates.sendEmail', [$student->id, 7]) }}" method="POST" style="display: inline;">
        @csrf
