...
<head>
    ...
    <style>
        ...
        @page { margin: 40px; }
        body { font-family: "DejaVu Sans", sans-serif; direction: rtl; text-align: center; color: #222; background: #edf500ff; }
...
<div class="actions">
    <a href="{{ route('pdf.download3', ['student' => $student]) }}" class="btn btn-primary">💾 حفظ الشهادة PDF</a>
