...
<head>
  ...
  <style>
    ...
    .actions{display:flex; justify-content:flex-end; margin-top:16px; gap:12px; flex-wrap:wrap;}
    .btn{
...
<body>
  <div class="container">
    <div class="card">
      ...
      <div class="subtitle">
        أدخل بريدك الإلكتروني ثم كلمة المرور الجديدة وتأكيدها، وسنُحدّث كلمة المرور الخاصة بحسابك.
      </div>

      {{-- إن كانت هناك رسالة حالة من Laravel (مثلاً تم إرسال الرابط سابقًا) --}}
      @if (session('status'))
      ...
      <form method="POST" action="{{ route('password.update') }}">
        ...
        <!-- التوكن المخفي القادم من رابط البريد -->
