...
<head>
  <meta charset="utf-8">
  <title>إرسال رابط إعادة تعيين كلمة المرور</title>
  ...
  <style>
    :root{
      ...
      --border:#e5e7eb; --ring:#c7d2fe; --success:#16a34a;
    }
    html,body{
...
<body>
  <div class="container">
    <div class="card">
      ...
      <div class="subtitle">
        أدخل بريدك الإلكتروني وسنرسل لك رابطًا لإعادة تعيين كلمة المرور الخاصة بحسابك.
      </div>

      {{-- رسالة حالة النجاح من Laravel (إن وُجدت) --}}
      @if (session('status'))
